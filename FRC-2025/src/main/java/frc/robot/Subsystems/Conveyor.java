...
public class Conveyor extends SubsystemBase {
    ...
    // sets the speed of the motor connected to the conveyor belt from -1 to 1 based
    // of parameter
    ...
    // returns if there is something(coral) in the of the sensor before the conveyor
    // belt
